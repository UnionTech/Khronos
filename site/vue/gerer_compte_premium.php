				...
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Changer son mot de passe</h2>
							<p></p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="cform" id="contact-form">
							...
							<form action="index.php?page=gerer_compte" method="post" role="form">
							  <div class="form-group">
								<label for="name">Nouveau mot de passe</label>
								<input type="text" name="mdp" class="form-control" id="mdp" placeholder="Votre nouveau mot de passe" data-rule="maxlen:60" data-msg="Please enter at least 4 chars" value=""/>
							  </div>
							  <button type="submit" class="btn btn-theme pull-left">VALIDER</button>
							</form>
						</div>
					</div>
		</section>
