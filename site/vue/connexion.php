				...
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Connexion</h2>
							<p></p>
						</div>
					</div>
				</div>
						...
						<div class="cform" id="contact-form">
							...
							<form action="index.php?page=connexion" method="post" role="form">
							  <div class="form-group">
								...
								<input type="email" name="mail" class="form-control" id="name" placeholder="Veuillez saisir votre mail" data-rule="email" data-msg="Please enter a valid email" />
								<div class="validation"></div>
							  </div>
							  <div class="form-group">
								<label for="pwd">Votre mot de passe</label>
								<input type="password" class="form-control" name="mdp" id="email" placeholder="Veuillez saisir votre mot de passe"  />
							  </div>
