			 ...
			 <div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
						...
						<li><a href="index.php?page=mail">Ma boîte mail personnelle</a></li>
				...
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Hébergement Premium</h2>
							<p></p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="cform" id="contact-form">
							...
							<!-- test -->
							<form action="index.php?page=hebergement" method="post" role="form">
								<label for="tmp">Pour combien de temps ? (en heures)</label>
        							<input type="text" name="tmp" id="inputWalls" value="">
								 <label for="tmp">Quel nom ? (en un seul mot)</label>
                                                                <input type="text" name="nom" id="inputWalls" value="">
							</div>
							<!-- fin test -->
							  <div class="form-group">
								<label for="bdd">Avec une base de données ?</label>
							<div class="btn-group" data-toggle="buttons" style="margin:0 auto">
    								<label class="btn btn-default **active**">
        								<input type="radio" name="bdd" id="inputWalls" value="y" checked>
    								oui </label>
    								<label class="btn btn-default **active**">
        								<input type="radio" name="bdd" id="inputWalls" value="n" checked>
    								non </label>
							</div>
							  </div>
							  <button type="submit" class="btn btn-theme pull-right">METTRE EN PLACE</button>
							</form>
						</div>
					</div>
					<!-- ./span12 -->
