				...
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Transfert de fichiers</h2>
							<p></p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="cform" id="contact-form">
							<form action="index.php?page=sftp" method="post" role="form">
								<input type="hidden"  name="validation"  value="1">
							<br><br><br>
							  <button type="submit" class="btn btn-theme pull-right">METTRE EN PLACE</button><br><br><br>
							</form>
						</div>
					</div>
					<!-- ./span12 -->
