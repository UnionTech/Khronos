				...
				<div class="row mar-bot40">
					<div class="col-md-6 col-md-offset-3">	
						<div class="align-center">
							<form action="index.php?page=adm_effacer" method="post" role="form">
							<input type="hidden" name="validation" value="1">
							<h3>Liste des sites :</h3>
							<table class="table">
								<?php listeSite(); ?>
							</table>
							<h3>Liste des comptes owncloud :</h3>
							<table class="table">
								<?php listecomptesowncloud(); ?>
							</table>
							<button type="submit" class="btn btn-theme pull-right">EFFACER</button>
							</form>
						</div>
					</div>
				</div>
