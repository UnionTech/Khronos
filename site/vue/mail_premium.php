			 ...
			 <div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
						<li><a href="index.php?page=accueil_premium">Retour accueil</a></li>
					</ul>
				</div><!--/.navbar-collapse -->
			</div>
                                ...
                                <div class="row">
                                        <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <div class="align-center">
                                                        ...
                                                        <p>
                                                        Une boite mail c'est bien,
                                                        </p>
                                                        <p>
                                                        Sans identification c'est mieux.
                                                        </p>
                                                </div>
                                        </div>
                                </div>
			...
			<div class="container">
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Mail premium</h2>
							<p></p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						<form action="index.php?page=mail" method="post" role="form">
								<label for="name">Nom du mail</label>
							        </br>
								</br>
							<div class="input-group-col-lg-6">
								<input type="text" name="mail" class="form-control" id="name" placeholder="Entrer un identifiant" data-rule="" data-msg=""><div class="input-group-addon">@khronos.itinet.fr</div></input>
							</div>
								</br>
