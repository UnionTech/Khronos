...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta charset="utf-8">
        ...
        <title>KHRONOS - Inscription</title>
				...
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Formulaire d'inscription</h2>
							<p></p>
						</div>
					</div>
				</div>
					...
					<div class="col-md-8 col-md-offset-2">
						...
						<form action="index.php?page=inscription" method="post" role="form">
							  <div class="form-group">
								...
								<input type="text" name="pseudo" class="form-control" id="pseudo" placeholder="Veuillez entrer votre identifiant" data-rule="maxlen:60" data-msg="Please enter at least 4 chars" value=""/>
							  </div>
							  <div class="form-group">
								<label for="name">Votre mail</label>
								<input type="text" name="mail" class="form-control" id="" placeholder="Veuillez entrer un mail valide (@khronos.itinet.fr non autorisé)" data-rule="maxlen:60" data-msg="Please enter at least 4 chars" value=""/>
							  </div>
							  <div class="form-group">
								<label for="email">Votre mot de passe</label>
								<input type="password" name="mdp" class="form-control" id="password" placeholder="(Entre 5 et 10 caractères)" data-rule="email" data-msg="Please enter a valid email" value=""/>
							  </div>
							  <div class="form-group">
								<label for="email">Vérification du mot de passe</label>
								<input type="password" name="repetition_mdp" class="form-control" id="password" placeholder="Veuillez répéter votre mot de passe" data-rule="email" data-msg="Please enter a valid email" value=""/>
							  </div>
						      <button type="submit" class="btn btn-theme pull-left">S'INSCRIRE</button>
						</form>
					</div>
				</div>
					<!-- ./span12 -->
