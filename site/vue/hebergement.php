				...
				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Hébergement</h2>
							<p></p>
						</div>
					</div>
				</div>
					...
					<div class="col-md-8 col-md-offset-2">
						<div class="cform" id="contact-form">
							...
							<form action="index.php?page=hebergement" method="post" role="form">
								<label for="tmp">Pour combien de temps ?</label>
							<div class="btn-group" data-toggle="buttons" style="margin:0 auto">
    								<label class="btn btn-default **active**">
        								<input type="radio" name="tmp" id="inputWalls" value="1" checked>
    								1 heure </label>
    								<label class="btn btn-default">
        								<input type="radio" name="tmp" id="inputWalls" value="24">
    								1 jour </label>
    								<label class="btn btn-default">
        								<input type="radio" name="tmp" id="inputWalls" value="72">
  	 							 3 jours </label>
    								<label class="btn btn-default">
        								<input type="radio" name="tmp" id="inputWalls" value="168">
    								1 semaine </label>	
							</div><br><br>
							<!-- fin test -->
