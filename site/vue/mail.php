			 ...
			 <div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
						<li><a href="index.php?page=accueil">Retour accueil</a></li>
					</ul>
				</div><!--/.navbar-collapse -->
			</div>
                                ...
                                <div class="row">
                                        <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <div class="align-center">
                                                        ...
                                                        <p>
                                                        Besoin d'une boite mail éphémère sans identification ?
                                                        </p>
                                                        <p>
                                                        N'hésitez pas et créez en une.
                                                        </p>
                                                </div>
                                        </div>
                                </div>
					...
					<div class="col-md-8 col-md-offset-2">
						<div class="cform" id="contact-form">
							<form action="index.php?page=mail" method="post" role="form">
								<label for="name">Nom du mail (en un seul mot)</label>
							        	</br>
									</br>
								<div class="form-group">
									<input type="text" name="mail" class="form-control" id="name" placeholder="Exemple : toto" data-rule="" data-msg=""/>
								</div>
