						...
						<div class="cform" id="contact-form">
							...
							<form action="index.php?page=inscription" method="post" role="form">
							  <div class="form-group">
								...
								<input type="text" name="pseudo" class="form-control" id="pseudo" placeholder="Votre pseudo" data-rule="maxlen:60" data-msg="Please enter at least 4 chars" value=""/>
							  </div>
							  <div class="form-group">
								<label for="name">Votre mail</label>
								<input type="text" name="mail" class="form-control" id="name" placeholder="Votre mail (pas de X@khronos.com)" data-rule="maxlen:60" data-msg="Please enter at least 4 chars" value=""/>
							  </div>
							  <div class="form-group">
								<label for="email">Votre mot de passe</label>
								<input type="text" class="form-control" name="mdp" id="mdp" placeholder="Votre mot de passe" data-rule="email" data-msg="Please enter a valid email" value=""/>
							  </div>
