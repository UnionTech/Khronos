						...
						<div class="cform" id="contact-form">
							...
							<form action="index.php?page=connexion" method="post" role="form">
							  <div class="form-group">
								...
								<input type="mail" name="mail" class="form-control" id="name" placeholder="Votre mail" data-rule="email" data-msg="Please enter a valid email" />
								<div class="validation"></div>
							  </div>
							  <div class="form-group">
								<label for="email">Votre mot de passe</label>
								<input type="password" class="form-control" name="mdp" id="email" placeholder="Votre mot de passe"  />
							  </div>
