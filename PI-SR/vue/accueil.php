			 ...
			 <div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
						...
						<li><a href="#section-works">Les services</a></li>
			...
			<div class="row mar-bot40">
				<div class="col-lg-4" >
					<div class="align-center">
						...
						<h4 class="text-bold">Novice</h4>
						<ul class="fa-ul">
							<li>Entre une heure et une semaine</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-lg-4" >
					<div class="align-center">
						...
						<ul class="fa-ul">
							<li>Entre une heure et un mois</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-lg-4" >
					<div class="align-center">
						...
						<ul class="fa-ul">
							<li>Entre une heure et six mois</li>
						</ul>
					</div>
				</div>
			</div>	
					...
					<div class="row align-center mar-bot40">
						<div class="col-md-3">
							<div class="team-member">
								<figure class="member-photo"><img src="vue/Amoeba/img/team/member1.jpg" alt="" /></figure>
						...
						<div class="col-md-3">
							<div class="team-member">
								<figure class="member-photo"><img src="vue/Amoeba/img/team/member2.jpg" alt="" /></figure>
								<div class="team-detail">
						...
						<div class="col-md-3">
							<div class="team-member">
								<figure class="member-photo"><img src="vue/Amoeba/img/team/member3.jpg" alt="" /></figure>
								<div class="team-detail">
						...
						<div class="col-md-3">
							<div class="team-member">
								<figure class="member-photo"><img src="vue/Amoeba/img/team/member4.jpg" alt="" /></figure>
								<div class="team-detail">
                              ...
                              <div class="portfolio-items isotopeWrapper clearfix" id="3">
                                <article class="col-md-4 isotopeItem webdesign">
									<div class="portfolio-item">
										<img src="vue/Amoeba/img/portfolio/img1.jpg" alt="" />
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="index.php?page=inscription">Basique</a></h5>
												<a href="vue/Amoeba/img/portfolio/img1.jpg" class="fancybox"><i class="fa fa-plus fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                <article class="col-md-4 isotopeItem photography">
									<div class="portfolio-item">
										<img src="vue/Amoeba/img/portfolio/img2.jpg" alt="" />
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="index.php?page=inscription">Basique</a></h5>
												<a href="vue/Amoeba/img/portfolio/img2.jpg" class="fancybox"><i class="fa fa-plus fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                <article class="col-md-4 isotopeItem photography">
									<div class="portfolio-item">
										<img src="vue/Amoeba/img/portfolio/img3.jpg" alt="" />
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="index.php">Premium</a></h5>
												<a href="vue/Amoeba/img/portfolio/img5.jpg" class="fancybox"><i class="fa fa-plus fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
                                <article class="col-md-4 isotopeItem webdesign">
									<div class="portfolio-item">
										<img src="vue/Amoeba/img/portfolio/img4.jpg" alt="" />
										 <div class="portfolio-desc align-center">
											<div class="folio-info">
												<h5><a href="index.php">Premium</a></h5>
												<a href="vue/Amoeba/img/portfolio/img6.jpg" class="fancybox"><i class="fa fa-plus fa-2x"></i></a>
											 </div>										   
										 </div>
									</div>
                                </article>
						...
						<div class="cform" id="contact-form">
							...
							<form action="vue/Amoeba/contact/contact.php" method="post" role="form" class="contactForm">
							  <div class="form-group">
								...
								<input type="text" name="name" class="form-control" id="name" placeholder="Votre nom" data-rule="maxlen:4" data-msg="Please enter at least 4 chars" />
