						...
						<div class="cform" id="contact-form">
							...
							<form action="index.php?page=hebergement" method="post" role="form">
							  <div class="form-group">
								...
								<input type="text" name="tmp" class="form-control" id="name" placeholder="Temps" data-rule="maxlen:60" data-msg="Please enter at least 4 chars" value=""/>
							  </div>
							  <div class="form-group">
								<label for="bdd">Avec une BDD ?</label>
								<input type="text" class="form-control" name="bdd" id="bdd" placeholder="y/n" data-rule="email" data-msg="Please enter a valid email" value=""/>
							  </div>
							  <button type="submit" class="btn btn-theme pull-left">CREER</button>
							</form>
						</div>
					</div>
					<!-- ./span12 -->
