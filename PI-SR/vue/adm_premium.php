		...
		<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
			 <div class="container">
				<div class="navbar-header">
					...
					<h1><a class="navbar-brand" href="index.php?page=adm_accueil" data-0="line-height:90px;" data-300="line-height:50px;">
					KHRONOS</a></h1>
				</div>
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
						<li class="active"><a href="index.php?page=hebergement"></a></li>
						<li><a href="index.php?page=adm_bannir">Bannir un utilisateur</a></li>
						<li><a href="index.php?page=adm_effacer">Effacer un contenu illicite</a></li>
						<li><a href="index.php?page=adm_premium">Faire passer un basique premium</a></li>
			...
			<div class="container"> 
				<div class="row mar-bot40">
					<div class="col-md-6 col-md-offset-3">	
						...
						<form action="index.php?page=adm_premium" method="post" role="form">
						<h3>Liste des utilisateurs basiques du site :</h3>
							<table class="table">
							<?php listeUser(); ?>
							</table>
							<button type="submit" class="btn btn-theme pull-right">LE FAIRE PASSER PREMIUM</button>
						</div>
						</form>
					</div>
				</div>
